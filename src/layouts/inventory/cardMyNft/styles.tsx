...
export const InvenLeftTitle = styled.div`
  position: relative;
  width: 350px;
  height: 74px;
  padding: 0 24px;
...
export const InvenLeftIcon = styled(ReactSVG)`
  width: 36px;
  height: 36px;
  svg {
    width: 36px;
...
export const InvenLeftTitleTypo = styled.div`
  font-size: ${({ theme }) => theme.sizes.font32};
  font-weight: 700;
  letter-spacing: 2px;
  color: ${({ theme }) => theme.colors.inventoryBg3};
`;

export const InvenLeftCorner = styled(ReactSVG)`
  display: flex;
  position: absolute;
  bottom: -3px;
  right: -20px;
...
export const InvenLeftContents = styled.div`
  position: relative;
  width: 100%;
